...
import com.ffms.contorller.income.IncomeSumByNameController;
import com.ffms.entity.FfmsResult;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations={"classpath:applicationContext.xml"})
public class IncomeFindByControllerTest {
	@Autowired
	private IncomeSumByNameController controller;
	...
	public void test1() throws Exception{
		RequestBuilder request = 
			...
			.post("/income/incomesumbyname.do")
			.param("name", "李维俊");
